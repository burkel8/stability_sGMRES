...
xticks([0 maxiter_plot/2 maxiter_plot]);
...
nexttile
semilogy(berr,'LineWidth', linewidth); hold on;
semilogy(berr2, 'LineWidth', linewidth); hold on;
semilogy(berr3, 'LineWidth', linewidth, 'LineStyle', ':');
...
nexttile
plot(tlog,'LineWidth', linewidth); hold on;
plot(tlog2, 'LineWidth', linewidth); hold on;
plot(tlog3, 'LineWidth', linewidth, 'LineStyle', ':');
...
nexttile
semilogy(taulog,'LineWidth', linewidth); hold on;
semilogy(taulog2, 'LineWidth', linewidth); hold on;
semilogy(taulog3, 'LineWidth', linewidth, 'LineStyle', ':');
